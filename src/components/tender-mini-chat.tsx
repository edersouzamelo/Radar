                    ...
                    {messages.length === 0 && (
                        <div className="h-full flex flex-col items-center justify-center text-center px-4 opacity-70">
                            <p className="text-xs font-medium text-slate-600 dark:text-slate-400">
                                Olá! Sou capaz de responder de imediato qualquer dúvida específica sobre <strong className="text-radar-gold">este pregão</strong>.
                            </p>
                            <span className="text-[10px] mt-2 block text-muted-foreground w-full">Por exemplo: "Quando vence o prazo do GCALC?", "Qual a última atualização?"</span>
                        </div>
                    )}
                        ...
                        <div key={message.id} className={cn("flex w-full gap-1.5", message.role === 'user' ? "justify-end" : "justify-start")}>
                            ...
                            <div
                                className={cn(
                                    ...
                                    message.role === "user"
                                        ? "bg-radar-dark text-white dark:bg-slate-700 border-transparent self-end rounded-tr-sm"
                                        : "bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 self-start rounded-tl-sm border-slate-200 dark:border-slate-700"
                                )}
                            >

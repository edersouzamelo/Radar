        ...
        <Card className="flex flex-col h-full min-h-[600px] w-full rounded-[1.5rem] border-none shadow-sm bg-white dark:bg-slate-900 border-2 border-transparent relative overflow-hidden group">
            ...
            <CardHeader className="pb-3 border-b border-slate-100 dark:border-slate-800">
                <CardTitle className="text-lg font-bold flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-radar-gold/40 shadow-sm bg-slate-100 dark:bg-slate-800 flex items-center justify-center shrink-0">
                            <img src="/salem.png" alt="Salém" className="w-full h-full object-cover object-top" />
                        </div>
                        <div className="flex flex-col">
                            <span className="leading-none text-radar-dark dark:text-white">Salém</span>
                ...
                <CardDescription className="text-xs pt-1">
                    Eu sou o Salém. Pergunte-me qualquer coisa sobre os processos licitatórios do sistema.
                </CardDescription>
            </CardHeader>
                    ...
                    {messages.length === 0 && (
                        <div className="h-full flex flex-col items-center justify-center text-center opacity-60 px-6">
                            ...
                            <p className="text-sm font-medium text-slate-700 dark:text-slate-300">
                                Olá! Sou Salém, seu assistente. Pergunte coisas como:
                            </p>
                            <div className="mt-3 flex flex-col gap-2 w-full text-xs">
                                <span className="bg-white dark:bg-slate-800 shadow-sm border border-slate-200 dark:border-slate-700 py-2 px-3 rounded-lg text-slate-600 dark:text-slate-400">"Quais processos estão homologados?"</span>
                                <span className="bg-white dark:bg-slate-800 shadow-sm border border-slate-200 dark:border-slate-700 py-2 px-3 rounded-lg text-slate-600 dark:text-slate-400">"Quem é o coordenador do pregão 94?"</span>
                            </div>
                        </div>
                    )}
